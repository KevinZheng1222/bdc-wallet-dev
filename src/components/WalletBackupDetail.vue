        ...
        <div class="page" id="page-wallet-backup-detail">
            ...
            <div class="content">
                ...
                <div class="content-block">
                    ...
                    <p>
                        <a class="button-bdc" v-if="!wifKey" @click="unlock">{{$t('wallet_backup.detail.unlock')}}</a>
                    </p>
                </div>
                ...
                <div class="button-block">
                    <p v-if="isNative&&wifKey">
                        <a href="javascript:;" @click="copyKey()" class="button button-bdc" :class="{disabled:keyCopied}">{{keyCopied ? $t('wallet_backup.detail.copied') : $t('wallet_backup.detail.copy')}}</a>
                    </p>
                    <p v-if="wifKey">
                        <a href="javascript:;" @click="confirm(link('/'))" class="button button-bdc">{{$t('wallet_backup.detail.go_back')}}</a>
                    </p>
                </div>
            </div>
        </div>
