        ...
        <div class="page">
            ...
            <div class="content">
                ...
                <div class="content-block button-block">
                    <p>
                        <router-link :to="linkBackupKey" class="button button-bdc">{{$t('wallet_backup.index.button_backup')}}
                        </router-link>
                    </p>
                    <p>
                        <a href="javascript:;" class="button button-bdc button-disabled" @click="delWallet">{{$t('wallet_backup.index.button_remove')}}</a>
                    </p>
                </div>
            </div>
        </div>
