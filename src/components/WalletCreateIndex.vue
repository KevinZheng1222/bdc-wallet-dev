            ...
            <div class="content">
                <div class="center-content">
                    ...
                    <div class="content-block block-button">
                        <p>
                            <router-link :to="link('/wallet-create-step-1',{from:$route.fullPath})" class="button button-bdc">
                                {{$t('wallet_create.index.button_create')}}
                            </router-link>
                        </p>
                        <p>
                            <router-link :to="link('/wallet-import',{from:$route.fullPath})" class="button button-bdc-secondary">
