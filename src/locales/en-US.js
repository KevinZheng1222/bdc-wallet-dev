const locale = {
    ...
    wallet_create: {
        index: {
            title: 'Wallet',
            tip_empty: 'bdc Wallet was not created',
    ...
    about: {
        ...
        version: 'V1.0.1',
        desc: {
            line1: 'bdc Wallet is a lite mobile wallet APP ',
            line2: 'to facilitate bdc transfer, collection, wallet management',
            line3: 'and review of updates on bdc at any time.'
        },
    ...
    disclaimer: {
        ...
        content: '<h4 class="text-center">Notice to Use and Disclaimer</h4>' +
            '<p>bdc Wallet is a decentralized blockchain application. Please acquire a full understanding of the blockchain technology before use. Make sure you have the basic competence to use and manage decentralized wallet on a reasonable level.</p>' +
            '<p>1. Once bdc Wallet account or password is lost, it is unable to retrieve. Please keep properly your account and password, and make sure to back up your private key to the wallet, which is the only credential to get back your wallet. GXChain is not responsible for the loss or theft of the wallet due to your failure to back up the private key, safekeep or properly use the wallet.</p>' +
            '<p>2. If you obtain bdc Wallet app or any other application under the same name of this sofeware from any unauthorized third party, bdc will not vouch for its security. You will be responsible for the loss inflicted thereby. </p>' +
            '<p>3. By transferring bdc via bdc wallet, you understand the IRRETRIEVABLE attribute of blockchain-based operation and will be responsible for irreversible loss due to your misoperation.</p>' +
            '<p>4. You shall comply with relevant state laws, policies and regulations when trading on bdc Wallet.</p>',
    ...
    transfer: {
        ...
        available: '<span class="color-danger">{amount}</span> bdc Available',
        memo: 'Memo',
        fee: 'Fee',
    ...
    loyalty_program: {
        ...
        tip3: 'bdc\'s Loyalty Program is a benefit program designed for investors to lock up certain amount of bdc (GX Share). During the lockup period, the capital is frozen, meanwhile investors are entitled to extra bonus. For example, lock up 10,000 bdc for 9 months; calculating by 6% annualized return,  you may get 450 bdc for bonus on the due date. bdc would like our investors to join the Loyalty Program and enjoy the long-term benefits brought by bdc\'s growth in the future.',
        ...
        available: '<span class="color-danger">{amount}</span> bdc Available',
        reward: '<span class="color-danger">{amount}</span> bdc Reward',
        join: 'Setup',
        history: 'History',
        no_record: 'No record',
        locked_at: 'Locked At',
        locked_amount: 'Locked Amount(bdc)',
        ...
        success: {
            title: 'Success',
            message: 'Congratulations,{amount} bdc were locked for join loyalty program'
        },
        detail: {
            title: 'Program Details',
            success: {
                title: 'Success',
                message: 'Congratulations,{amount} bdc were unlocked.'
            }
        }
    },
    realtime_quotations: {
